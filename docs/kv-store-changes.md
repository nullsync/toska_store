...
- Added scoped and named KV/admin/replication auth tokens, optional admin/replication endpoint mTLS, write/admin audit logs, rate limiting, and read-only enforcement in follower mode.
